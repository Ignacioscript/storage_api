...
class Container_fe4adc4165 extends _PHPStan_e870ac104\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0381(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_fe4adc4165 $container)
			{
	...
	public function createServiceContainer(): Container_fe4adc4165
	{
		return $this;
	}
